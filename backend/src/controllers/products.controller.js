...
var products_service_js_1 = require("@services/products.service.js");
var ProductController = /** @class */ (function () {
    function ProductController() {
        ...
        this.getAllProducts = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.productService.getAllProducts()];
                    case 1:
                        products = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, this.productService.getProductById(Number(id))];
                    case 1:
                        product = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        id = req.params.id;
                        product = req.body;
                        return [4 /*yield*/, this.productService.updateProduct(Number(id), product)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, this.productService.deleteProduct(Number(id))];
                    case 1:
        ...
        this.productService = new products_service_js_1.ProductService();
    }
