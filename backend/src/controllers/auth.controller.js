...
var log_service_js_1 = require("@services/log.service.js");
var AuthController = /** @class */ (function () {
    function AuthController() {
        ...
        this.login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, this.logService.createLog(req, { email: req.body.email, action: 'login', entityType: 'user', description: 'Usuario inició sesión' })];
                    case 2:
                        _a.sent();
                        res.json(result);
                        return [3 /*break*/, 4];
        ...
        this.register = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [4 /*yield*/, this.logService.createLog(req, { email: req.body.email, action: 'register', entityType: 'user', description: 'Usuario registró una cuenta' })];
                    case 2:
                        _a.sent();
                        res.json(result);
                        return [3 /*break*/, 4];
        ...
        this.logService = new log_service_js_1.LogService();
    }
