...
function seedProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var products, _i, products_1, product, attributes, images, productData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    attributes = product.attributes, images = product.images, productData = __rest(product, ["attributes", "images"]);
                    return [4 /*yield*/, prisma.product.upsert({
                            where: { sku: product.sku },
                            update: __assign(__assign({}, productData), { attributes: {
                                    deleteMany: {},
                            ...
                            create: __assign(__assign({}, productData), { attributes: attributes, images: images }),
                        })];
                case 2:
                    _a.sent();
                    _a.label = 3;
