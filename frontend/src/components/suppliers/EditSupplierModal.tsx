...
export const EditSupplierModal = ({ open, onOpenChange, supplier }: EditSupplierModalProps) => {
            ...
            <div>
              ...
              <Select value={formData.category} onValueChange={(value) => setFormData({ ...formData, category: value })}>
                ...
                <SelectContent className="bg-gray-800 border-gray-600">
                  ...
                  <SelectItem value="Libros" className="text-white hover:bg-gray-700 focus:bg-gray-700">Libros</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
