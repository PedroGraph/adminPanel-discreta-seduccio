...
export const CouponsFilters = ({
  ...
  const t = useI18n();
  const tr = t("coupons_filters") as any;
      ...
      <div className="flex gap-2">
        <Select value={statusFilter} onValueChange={onStatusFilterChange}>
          ...
          <SelectContent className="bg-gray-800 text-purple-100 border-purple-700 z-30">
            <SelectItem value="all" className="text-purple-200 hover:bg-purple-900 focus:bg-purple-900">{tr.all}</SelectItem>
            <SelectItem value="active" className="text-green-300 hover:bg-green-900 focus:bg-green-900">{tr.active}</SelectItem>
            <SelectItem value="inactive" className="text-blue-300 hover:bg-blue-900 focus:bg-blue-900">{tr.inactive}</SelectItem>
            <SelectItem value="expired" className="text-red-300 hover:bg-red-900 focus:bg-red-900">{tr.expired}</SelectItem>
          </SelectContent>
        </Select>
        <Select value={typeFilter} onValueChange={onTypeFilterChange}>
          ...
          <SelectContent className="bg-gray-800 text-purple-100 border-purple-700 z-30">
            ...
            <SelectItem value="percentage" className="text-purple-200 hover:bg-purple-900 focus:bg-purple-900">{tr.percentage}</SelectItem>
            <SelectItem value="fixed" className="text-purple-200 hover:bg-purple-900 focus:bg-purple-900">{tr.fixed}</SelectItem>
            <SelectItem value="free_shipping" className="text-purple-200 hover:bg-purple-900 focus:bg-purple-900">{tr.free_shipping}</SelectItem>
          </SelectContent>
        </Select>
        <Button
          variant="outline"
