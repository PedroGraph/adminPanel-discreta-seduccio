  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      <div className="relative flex-1">
        ...
        <Input
          placeholder={t("activity_log_search")}
          value={searchTerm}
      ...
      <div className="flex gap-2 flex-wrap">
        <Select value={categoryFilter} onValueChange={setCategoryFilter}>
          <SelectTrigger className="w-full sm:w-40 bg-gray-800 border-purple-700 text-purple-200 focus:ring-2 focus:ring-purple-700">
            <SelectValue placeholder={t("activity_log_category")} className="text-purple-300" />
          </SelectTrigger>
          <SelectContent className="bg-gray-800 text-purple-100 border-purple-700 z-30">
            <SelectItem value="all" className="text-purple-200 hover:bg-purple-900">{t("activity_log_all_categories")}</SelectItem>
        ...
        <Select value={userFilter} onValueChange={setUserFilter}>
          <SelectTrigger className="w-full sm:w-40 bg-gray-800 border-purple-700 text-purple-200 focus:ring-2 focus:ring-purple-700">
            <SelectValue placeholder={t("activity_log_user")} className="text-purple-300" />
          </SelectTrigger>
          <SelectContent className="bg-gray-800 text-purple-100 border-purple-700 z-30">
            <SelectItem value="all" className="text-purple-200 hover:bg-purple-900">{t("activity_log_all_users")}</SelectItem>
